    ...
    switch (op.type) {
      ...
      default: {
        ...
        if (op.target.type == Operand::Type::DIRECT && op.target == op.source) {
          ...
          else if (op.type == Operation::Type::SUB || op.type == Operation::Type::TRN) {
            op.type = Operation::Type::MOV;
          ...
          // equ $n,$n / leq $n,$n / geq $n,$n / bin $n,$n / dgs $n,$n / dgr $n,$n => mov $n,1
...
bool canMerge(Operation::Type a, Operation::Type b) {
  if ((a == Operation::Type::ADD || a == Operation::Type::SUB) &&
      (b == Operation::Type::ADD || b == Operation::Type::SUB || b == Operation::Type::TRN ||
                  b == Operation::Type::EQU ||
                  b == Operation::Type::NEQ ||
                  b == Operation::Type::LEQ ||
                  b == Operation::Type::GEQ)) {
    return true;
  }
  if (a == b && (a == Operation::Type::MUL || a == Operation::Type::DIV || a == Operation::Type::POW || a == Operation::Type::NRT
   || a == Operation::Type::BAN || a == Operation::Type::BOR || a == Operation::Type::BXO)) {
    return true;
  }
